...
<body>
	...
	<div class="container content">
		...
		<div class="action">
			<h1 class="page-title">Create/Edit Tags</h1>
			<form method="post" action="<?php echo BASE_URL . 'admin/topics.php'; ?>" >
				...
				<?php endif ?>
				<input type="text" name="topic_name" value="<?php echo $topic_name; ?>" placeholder="Tag">
				<!-- if editing topic, display the update button instead of create button -->
				<?php if ($isEditingTag === true): ?> 
					<button type="submit" class="btn" name="update_topic">UPDATE</button>
				<?php else: ?>
					<button type="submit" class="btn" name="create_topic">Save Tag</button>
				<?php endif ?>
			</form>
		</div>
		<!-- // Middle form - to create and edit -->
